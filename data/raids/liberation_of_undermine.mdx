...
[*Feral]
<Talents 
  name="One-Armed Bandit Wildstalker Talents"
  talents="CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAmZb2MzCzMzMb2MjtZmZmHYmBAAAAAYLY2gxMjaGzCLzMjxMzMAAAAAAAAAAAgAgZbmlmtZW2AzAwiZwA" 
  colors={[
    { color: "purple", nodes: ["Lunar Inspiration", "Taste for Blood", "Rip and Tear"] }
  ]}
  comment="You can optionally switch out Taste for Blood for Lunar Inspiration, Rip and Tear for Veinripper, or play druid of the claw"
/>
