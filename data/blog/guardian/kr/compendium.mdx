...
Despite being a "ToI-Centric" build, the primary focus of this build is !441605|찢어발기기!. For a detailed overview of the rotation refer to the Rotation section above but in general the goal of this build is to spend as many !Maul! modifiers (!Tooth and Claw!, !Vicious Cycle!) on !441605|찢어발기기! as possible. As a consequence of this we actively press !Maul! less because they would consume the buffs that we ideally use to get massive !441605|찢어발기기! casts. Because we can only press !441605|찢어발기기! when it procs and we press !Maul! infrequently to save the modifiers our last remaining option is to spend rage on !Ironfur! for damage - hence this being a (technically) "ToI" build.
