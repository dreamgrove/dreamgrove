...
- [*Dotc_Heart of the Wild_cleave&&~Dotc_Wildpower Surge_cleave] !319454|야생의 정수! if available. Ideally press this as you are running into a pull to save yourself the global during combat.
...
- Press !441605|찢어발기기! (on your priority target if there is one)
- Press !Thrash! if not at max stacks of the debuff or if it is about to expire 
- [*Dotc_Heart of the Wild_aoe] !319454|야생의 정수! if available. Ideally press this as you are running into a pull to save yourself the global during combat.
...
- [*~Dotc_Single Target_incarn] Press !441605|찢어발기기! (on your priority target if there is one)
- Press !Thrash! if not at max stacks of the debuff or if it is about to expire
