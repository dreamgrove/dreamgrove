...
Overlapping cooldowns with a direct damage reduction component (!Barkskin!, !Survival Instincts! and !Pulverize!) is less ideal than spacing them out because multiple instances of damage reduction reduce the effectiveness of the cooldowns i.e. they are multiplicative with one and other, not additive. 
