...
Important to note that Elune's chosen (at least the builds presented here) is noticably easier to play. There is no form of catweaving to worry about and generally less attention will be focused on tracking buffs like !Vicious Cycle!/!Tooth and Claw!. Worth baring in mind if you're looking for a simpler rotation and playstyle, albeit at the cost of a significant amount of damage - around 25-30% compared to that of the highest performing Druid of the Claw build on single target.
...
<Collapsible title="Example Talent Builds">
...
![GuardianDotCM+](public/static/images/Guardian-DotC-mythic+11-1.png)
...
![GuardianECM+](/public/static/images/Guardian-EC-mythic+11-1.png)
