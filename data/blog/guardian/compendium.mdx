...
- [*Dotc_Wildpower Surge] If at 6 stacks of Feline Potential then:
    ...
    - [*Dotc_Tooth and Claw] If you do not have the rage to cast !Maul! at the start of this sequence then cast !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
...
- Press !33917|Mangle!
- Press !Thrash!
- [*Dotc_Catweaving_cleave] Please note, the following points (full catweaving) are only a net gain for 2 target cleave:
...
- [*Dotc_Catweaving_cleave] Press !Rake! on a target if rake is not already active (or it is in pandemic range) and you are below 40 rage
- [*Dotc_Catweaving_cleave] Press !Shred! if:
...
<Checkbox isIcon id="Dotc_Convoke the Spirits_incarn" spellId={391528} name="Convoke the Spirits" />
