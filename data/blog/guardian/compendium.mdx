...
- Press !Ravage! (on your priority target if there is one)
- Press !Thrash! if not at max stacks of the debuff or if it is about to expire 
...
- [*Dotc_Single Target_incarn] Press !Ravage!
- [*~Dotc_Single Target_incarn] Press !Ravage! (on your priority target if there is one)
...
Despite being a "ToI-Centric" build, the primary focus of this build is !Ravage!. For a detailed overview of the rotation refer to the Rotation section above but in general the goal of this build is to spend as many !Maul! modifiers (Tooth and Claw, Vicious Cycle) on !Ravage! as possible. As a consequence of this we actively press !Maul! less because they would consume the buffs that we ideally use to get massive !Ravage! casts. Because we can only press !Ravage! when it procs and we press !Maul! infrequently to save the modifiers our last remaining option is to spend rage on !Ironfur! for damage - hence this being a (technically) "ToI" build.
