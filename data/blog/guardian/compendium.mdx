...
- [*Dotc_Wildpower Surge] If at 6 stacks of Feline Potential then:
    - [*Dotc_Tooth and Claw&&Dotc_Convoke the Spirits] !Maul! > !Rake! > !Convoke the Spirits! (if available) > !Rip! > !33917|Mangle!
    - [*Dotc_Tooth and Claw&&~Dotc_Convoke the Spirits] !Maul! > !Rake! > !Rip! > !33917|Mangle!
    - [*Dotc_Tooth and Claw&&~Dotc_Convoke the Spirits] If you do not have rage to !Maul! after hitting 6 stacks then: !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*Dotc_Tooth and Claw&&Dotc_Convoke the Spirits] If you do not have the rage to cast !Maul! at the start of this sequence then simply skip it. Convoke's channel time will ensure that !33917|Mangle! is available after the !Rip! is cast.
    ...
    - [*~Dotc_Tooth and Claw&&Dotc_Convoke the Spirits] If !Convoke the Spirits! is available and ready to use then:
        -Dump rage into !Ironfur! then !Rake! > !Convoke the Spirits! (if available) > !Rip! > !33917|Mangle!
    - [*~Dotc_Tooth and Claw&&Dotc_Convoke the Spirits] If !Convoke the Spirits! is not available and ready to use then:
        - Dump rage into !Ironfur! then !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*~Dotc_Tooth and Claw&&~Dotc_Convoke the Spirits] Dump rage into !Ironfur! then !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
...
- [*Dotc_Wildpower Surge_incarn&&Dotc_Single Target_incarn] If at 6 stacks of Feline Potential then:
    - [*Dotc_Tooth and Claw_incarn&&Dotc_Convoke the Spirits_incarn] !Maul! > !Rake! > !Convoke the Spirits! (if available) > !Rip! > !33917|Mangle!
    - [*Dotc_Tooth and Claw_incarn&&~Dotc_Convoke the Spirits_incarn] !Maul! > !Rake! > !Rip! > !33917|Mangle!
    - [*Dotc_Tooth and Claw_incarn&&~Dotc_Convoke the Spirits_incarn] If you do not have rage to !Maul! after hitting 6 stacks then: !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*Dotc_Tooth and Claw_incarn&&Dotc_Convoke the Spirits_incarn] If you do not have the rage to cast !Maul! at the start of this sequence then simply skip it. Convoke's channel time will ensure that !33917|Mangle! is available after the !Rip! is cast.
    ...
    - [*~Dotc_Tooth and Claw_incarn&&Dotc_Convoke the Spirits_incarn] If !Convoke the Spirits! is not available and ready to use then:
        - Dump rage into !Ironfur! then !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*~Dotc_Tooth and Claw_incarn&&~Dotc_Convoke the Spirits_incarn] Dump rage into !Ironfur! then !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
...
- [*Dotc_Wildpower Surge_incarn&&Dotc_Cleave_incarn] (The following is only a gain on 2T) If at 6 stacks of Feline Potential then:
    - [*Dotc_Tooth and Claw_incarn] !Raze! > !Rake! > !Rip! > !33917|Mangle!
    - [*Dotc_Tooth and Claw_incarn] If you do not have rage to !Raze! after hitting 6 stacks then: !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*~Dotc_Tooth and Claw_incarn] Dump rage into !Ironfur! then !Rake! > !Rip! > !Shred! (until !33917|Mangle! is available) > !33917|Mangle!
    - [*Dotc_Convoke the Spirits_incarn] Press !Convoke the Spirits! immediately before you !Rip! in this sequence
    - If an empowered !Rip! is still active on the target then replace !Rip! in the above sequences with a !Ferocious Bite! cast
    - If !Rake! is already active and not within pandemic then replace !Rake! with !Shred! in the above sequences
- [*Dotc_Wildpower Surge_incarn] Press !33917|Mangle! if at < 6 stacks of Feline Potential
