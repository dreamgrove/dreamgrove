...
This is around a 4% buff on ST in raid builds. For !Elune's Chosen! in m+ it's a small nerf to AoE, but overall a buff in mythic+ builds when including the buff to !Starsurge! and the class aura.
