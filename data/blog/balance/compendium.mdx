...
- [*Convoke the SpiritsKOTG] Use !Convoke the Spirits! either when 
  - You are below 40 AP.
...
<Talents name={"Single Target"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWowMzMMMzAmZYmZsAbjxYmZbGLYmZmx2MmZMjxGYhBYA2WGLYamZZEAAAgNzMM"}/>
...
<Talents name={"Keeper of the Grove build"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWoYmZmhxMzAmZYmZsAbMMzMLzMLGzMzM2mxYYG2ALAYAWWGLYamZZEAAAgNzMmB"}/>
...
On 3 targets and more, enter Lunar Eclipse and cast !Starfire!.
...
!Control of the Dream! is a talent that lets you hold on to either !194223|Celestial Alignment!/!102560|Incarnation!, !Convoke the Spirits! or !205636|Force of Nature! for up to 15 seconds without losing a use, subtracting the amount of time you held the ability from its cooldown. This also stacks out of combat, meaning your first !Force of Nature! will have a 30/45 second cooldown compared to 45/60 seconds depending on whether you play !Early Spring! or not. 
...
[Flask of Alchemical Chaos](https://www.wowhead.com/item=212283/flask-of-alchemical-chaos) 
...
Please use Top Gear on [Raidbots](https://www.raidbots.com/simbot) in order to decide what trinkets to use/farm, but the following list should give you a good idea of some of the trinkets you will want to look out for. The list is in roughly power-level order assuming the highest item level versions of the trinkets.
    ...
    - [Spymaster's Web](https://www.wowhead.com/item=220202/spymasters-web)
    - [Ara-Kara Sacbrood](https://www.wowhead.com/item=219314/ara-kara-sacbrood)
    - [Gale of Shadows](https://www.wowhead.com/item=133304/gale-of-shadows?ilvl=639&spec=102)
    - [Empowering Crystal of Anub'ikkaj](https://www.wowhead.com/item=219312/empowering-crystal-of-anubikkaj?class=11&ilvl=639&spec=102)
    - [Unbound Changeling](https://www.wowhead.com/item=178708/unbound-changeling?class=11&ilvl=639&spec=102)
    - [Ovi'nax's Mercurial Egg](https://www.wowhead.com/item=220305/ovinaxs-mercurial-egg?ilvl=639&spec=102)
    ...
    - [Harvester's Edict](https://www.wowhead.com/item=219317/harvesters-edict?class=11&ilvl=639&spec=102)
