...
<CheckboxProvider>
<div className="col-span-2 grid  md:grid-cols-3 grid-cols-1 gap-x-4 gap-y-1">
  <Checkbox id="ClassTree" spellId={137009} name="Class Tree" defaultCheck/>
  <Checkbox id="KeeperTree" spellId={205636} name="Keeper of the Grove" defaultCheck radio="heroimage"/>
  <Checkbox id="ECTree" spellId={202770} name="Elune's Chosen" radio="heroimage"/>
</div>
</CheckboxProvider>

[*ClassTree] ![Class Tree](/static/images/CLASSTREEBALANCE.png)

[*KeeperTree] ![Keeper Talents](/static/images/TALENTBOXKOTG.png)

[*ECTree] ![EC Talents](/static/images/TALENTBOXEC.png)
