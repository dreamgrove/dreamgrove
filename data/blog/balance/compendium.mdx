...
<Collapsible title="11.2 Tier Set Explanation & Video">

<Collapsible title="Video: 11.2 Tier Set Thoughts">
  <YouTube id="R_KOhMc-Zew"/>
</Collapsible>

The Dreamgrove community has posted some extensive feedback regarding the state of Balance Druid going into the last season of The War Within and with Midnight on the horizon that can be [found here](https://us.forums.blizzard.com/en/wow/t/balance-druid-112-feedback-beyond/2127238).

We have also posted some feedback regarding the 11.2 tier sets that can be [found here](https://us.forums.blizzard.com/en/wow/t/feedback-the-war-within-season-3-class-sets/2119870/139).
...
The free !Starsurge! procs have the same properties as a regular !Starsurge!, helping reduce !Fury of Elune! cooldown through !Lunation!, stacks !Starlord! and procs !Power of Goldrinn!.
...
This buff stacks to a maximum of 6 and resets the duration to 20 seconds when a new stack is gained. Equals to a maximum of 24% damage amp after using !Fury of Elune! or !Full Moon!. The !Full Moon! cast that procs it does not benefit from the effect. The stacks only gets consumed by the actual !Fury of Elune! or !Full Moon! casts and not procs like !Orbit Breaker! or !Sundered Firmament!.
...
This tier set is very strong and the 4-piece buffed !197626|Starsurges!, if you crit, can deal a lot of damage. There are however currently an amount of bugs or issues with the tier set, like the spawned Dryad currently not doing any damage or the total cap of the 4pc damage being based on your max HP leading to some tech where you enter !Bear Form! at the end of your ramp to increase the cap. You can find more in-depth explanation of these bugs on the WoW forum and the [tier set feedback post](https://us.forums.blizzard.com/en/wow/t/feedback-the-war-within-season-3-class-sets/2119870/139). This tier set is significantly stronger in AoE scenarios where you can funnel off of mobs and more easily hit the cap than in single target or raid scenarios. 

</Collapsible>

<Collapsible title="11.1.7 News">

### 11.1.7 D.I.S.C Belt

[Patch 11.1.7](https://www.wowhead.com/news/patch-11-1-7-official-patch-notes-releases-june-17th-377229) is releasing with the new [D.I.S.C Belt](https://www.wowhead.com/ptr/item=245964/durable-information-securing-container?bonus=523&class=11&ilvl=701&spec=102) that works similiarly to the [Cyrce's Circlet](https://www.wowhead.com/item=228411/cyrces-circlet) from 11.0.7. The base ilvl of the belt is 691 increasing through 4 weeks of weekly content to a maximum of 701. It is worth equipping the belt instantly after you acquired the powers. Look in the [Gearing & Consumables](https://www.dreamgrove.gg/blog/balance/compendium#gearing--consumables) section for information on what powers to choose.

### Turbo Boost 

There are some situations where [Cyrce's Circlet](https://www.wowhead.com/item=228411/cyrces-circlet) is worth swapping out for 684 ring in M+. Run an [MDT Sim](https://wago.io/Yya4XBbl-) or 1 target 5 minute patchwerk sim to find out what is better for you.
There is a section in [Gear & Consumables](#puzzling-cartel-chip) listing the items you should look out for when spending your Puzzling Cartel Chip. Remember to sim your character.

</Collapsible>

<Collapsible title="Season 2 Tier Set">
