...
## 11.1 PTR News
- New tier set: The [2-piece](https://www.wowhead.com/ptr-2/spell=1215695/druid-balance-11-1-class-set-2pc) and [4-piece](https://www.wowhead.com/ptr-2/spell=1215698/druid-balance-11-1-class-set-4pc) revolve around your damaging abilities proccing !Wild Mushroom! and gaining 20% more damage on !Starsurge! and !Starfall! to targets affected by their debuff. Currently the 4-piece does not function if you don't talent into !Wild Mushroom! or !Sunseeker Mushroom! as they are required for the DoT to be active. This tier set is a lot more valuable in AoE.

- Updated class tree: The update to the class tree improved pathing a lot, and makes it easier to access any utility you want, and still lets you have points left over to spend on whatever defensives you want. There is a change to [Fluid Form](https://www.wowhead.com/spell=449193/fluid-form) that makes !Wrath! and !Starfire! shift you into !Moonkin Form! at the end of the cast instead of the start of the cast.

- As usual, the Dreamgrove team has written up a post on the 11.1 PTR Forum with some feedback for the current issues with the spec. [You can find it here](https://us.forums.blizzard.com/en/wow/t/111-balance-druid-feedback/2044123).


## 11.0.7 Update

- 11.0.7 introduces the [Cyrce's Circlet](https://www.wowhead.com/ptr/item=228411/cyrces-circlet) ring and the Siren Isle zone. The ring has 3 sockets in it, that you fill with [singing citrine gems](https://www.wowhead.com/guide/the-war-within/patch-11-0-7-cyrces-circlet-customizable-ring) that you collect as you do content on the Siren Isle. Blizzard has confirmed that they are tuning the ring to be your most powerful option for the remainder of the season, while also being competitive with rings at heroic raid ilvl for season 2. As always, it is recommended that you sim what gems are best for your character using Top Gear on Raidbots. In intial sims, it seems that [Fathomdweller's](https://www.wowhead.com/ptr/item=228639/fathomdwellers-runed-citrine), [Stormbringer's](https://www.wowhead.com/ptr/item=228638/stormbringers-runed-citrine) and [Legendary Skipper's](https://www.wowhead.com/ptr/item=228646/legendary-skippers-citrine) are the best performing options, but this can change quickly as Blizzard adjusts the relative power of the gems.

## Current Bugs

- !Harmony of the Heavens! is not stacking correctly if you press !194223|CA!/!102560|Inc! after using !Starsurge! or !Starfall! during Lunar Eclipse or outside of Eclipse. It currently seems to count spenders cast during Lunar Eclipse towards the cap, even after using !194223|CA!/!102560|Inc! resets, meaning that your %dmg increase from Eclipse doesn't go to 21% during your cooldown and is instead stuck at 15%. The way to play around this is to use !194223|CA!/!102560|Inc! in a fresh Eclipse, or right after exiting an Eclipse. The talent does however work as intended with Solar Eclipse.
...
[Sim for tier set](https://mimiron.raidbots.com/simbot/report/5YZHSh7mNFKkTo4XF5Sw34)
...
<HeroTalentsHeader id="generic" title="Opener">
...
<CheckboxProvider>
  ...
  <Checkbox id="EC" spellId={202770} name="Fury of Elune" />
  <Checkbox id="KEEPER" spellId={205636} name="Force of Nature" />
</CheckboxProvider>

[*KOTGFLARE&&KOTGCONVOKE&&~EC]  <Timeline spellIds={[190984, 190984, 202347, 164812, 164815, 205636, 194223, 197626, 197626, 197626, 391528]}> USE TRINKET + POT WITH !194223|CA!/!102560|Inc! </Timeline>

[*KOTGFLARE&&~KOTGCONVOKE&&~EC] <Timeline spellIds={[190984, 190984, 202347, 164812, 164815, 205636, 194223, 197626, 197626, 197626]} > COMMENT </Timeline>
...
<Talents name={"Single Target (Sikran, Rasha'nan, Nexus Princess Kyveza)"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUYmZGGmZAzMMzYAbzMGmZbGLGzMzMzixMjZmxGYjBYA22GLYamZZEAAAgNzMGDA"}/>
...
<Talents name={"Broodtwister Ovi'nax Elune's Chosen"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALjCzMzwwMDYmhZmBDbMLGzsNjNzMzMzMLmlxwMsBWYAGLbzshxsMCMBAAAYxMjxA"}/>

<Talents name={"Broodtwister Ovi'Nax Keeper of the Grove"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUYmZGGmZAzMMzMAbzMbGzsMzsYMzMzMLGjhZGbgFGgBYbbsgpZmlRAAAA2MzYMA"}/>

<Talents name={"Silken Court Keeper of the Grove"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALjCzMGGmZAzMMzYYYbmhZZsNzsYMzMjZZGjhZGbgNAMAbbjFMNzsMCAAAwmZGzMA"}/>

<Talents name={"Silken Court Elune's Chosen"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALjCzMzwgZAzMMzMYYbMLGzsNzsZmZmZmZzsMGmhNwCDwYZbmNMmtRgJAAAALmZMA"}/>

<Talents name={"Queen Ansurek"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALjCzMGGmZAzMMzMYYbMMLzsNjFjZmZmZxYMmZGbgFGgBYbbsgpZmlRAAAA2MzYMA"}/>
...
<Talents name={"Elune's Chosen build"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUMmZGGzMDYmhZmZWgNmFzyMLzMbmZmZmZWMLjhBbgFAMW2mZDjZbEYCAAAwiZGDA"}/>

## Talent Explanations

<div className="border border-gray-300 mb-2">
![Keeper Talents](/static/images/KOTG_Tree.png)
</div>
<div className="border border-gray-300 mb-2">
![EC Talents](/static/images/EC_Tree.png)
</div>
...
!Innervate! is a good node for raid, but not as easy to take in mythic+. Communicate with your raid leader and healers on the best use for this on a particular fight. If your healers are not asking for your !Innervate!, consider talenting out of it for another defensive option.

!Oakskin! is a good defensive talent that is good to take for every scenario. Accessing this section of talents forces you to route through !Instincts of the Claw! which is useless for Balance Druid.

!Incapacitating Roar! is a good node for mythic+ where AoE stops are sometimes mandatory. 

!Well-Honed Instincts! is another defensive node that you can take if necessary.
...
[Treacherous Transmitter](https://www.wowhead.com/item=221023/treacherous-transmitter?ilvl=639&spec=102) is an on-use trinket that gives you a random task to perform out of 3 possible tasks, either collect an orb, stand in a circle or jump 3 times to get a primary stat buff. This trinket is good paired with !Keeper of the Grove!'s burst cooldowns, but not as good for !Elune's Chosen! as it has a more flat damage profile.
