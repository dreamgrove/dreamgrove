...
- !Eclipse! is now a single button on a shorter 0.5s GCD - The button changes depending on your last builder used. 15 second duration, 30 second cooldown. There is a talent (mandatory) that makes it 2 charges and another talent (optional) that makes it 28 second cooldown.
...
- !Starlord! is no longer cancellable. 
...
- There are no widely known current bugs. If you find any, message Gamz through the Dreamgrove discord and let him know and it'll be put in here! 

# Rotation

### THE ROTATION SECTION IS NOT YET UPDATED FOR THE MIDNIGHT REWORK. CHECK BACK BEFORE THE START OF SEASON 1!
