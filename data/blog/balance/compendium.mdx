...
- This is around a 7% buff on ST for both hero talents. The buff to !Wrath! has resulted in some talent changes for ST and builds in the talent section has been updated.
...
<Talents name={"Single Target"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUmtmxYmBMzCLzMDzwMLjlZ2mxCzMmZWmxMjZmxGWYAGgttxCmmZWGBAAAYjZMAbGYA"}/>

<Talents name={"Single Target Cleave"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUmtmxYmBMzCLzMDzwMmZZmtZswMzMzsMjxYmZshFGgBYbbsgpZmlRAAAA2YGDwmBG"}/>
