...
This is approximately ~X% dmg increase from having no set.
...
[Sim for tier set](https://www.localhost:3000/static/sims/tiersims3.htm)
...
<Talents 
  ...
  talents="CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUmtMGzMwDYWYZmZAzMGmZbGLMzMzMLzYmxMzYDbMADw22YBTzMLjAAAAsZmZmBsZgB" 
  colors={[
    { color: "red", nodes: ["Rake", "Rip", "Maim", "Grievous Wounds", "Remove Corruption", "Primal Fury", "Rejuvenation", "Wild Growth", "Instincts of the Claw", "Symbiotic Relationship", "Lingering Healing", "Thrash", "Ironfur", "Astral Communion", "Radiant Moonlight"] },
    { color: "#fbff04ff", nodes: ["Hibernate, Remove Corruption, Killer Instinct", "Astral Influence", "Light of the Sun", "Lycara's Meditation", "Forestwalk", "Incapacitating Roar", "Improved Stampeding Roar", "Nature's Balance", "Twin Moons", "Astronomical Impact", "Ursine Vigor", "Perfectly Honed Instincts", "Matted Fur", "Fluid Form", "Gale Tempest", "Umbral Inspiration", "Touch the Cosmos", "Hail of Stars", "Fury of Elune", "Elune's Guidance", "Crashing Star", "Denizens of the Dream", "Stellar Flare", "Elune's Guidance"] }
  ]} 
> 
...
<Talents 
  ...
  talents="CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUmtMGzMwDYWYZmZAzMLzsMzyM2MzMmZWMLjxMzAWYAGLbzshxsNCMBAAAYxMzMAbGYA" 
  colors={[
    { color: "red", nodes: ["Rake", "Rip", "Maim", "Grievous Wounds", "Power of Goldrinn", "Primal Fury", "Rejuvenation", "Wild Growth", "Instincts of the Claw", "Symbiotic Relationship", "Lingering Healing", "Thrash", "Ironfur", "Nature's Balance", "Crashing Star", "Touch the Cosmos", "Hail of Stars", "Stellar Amplification", "Astral Communion"] },
