...
- !Harmony of the Heavens! counts spenders cast outside of !Eclipse! towards your next !Eclipse!'s bonus, but does not increase the damage bonus.

# Rotation

<HeroTalentsHeader id="generic" title="Openers">
<CheckboxProvider>
  <Checkbox id="KEEPER" spellId={205636} name="Keeper of the Grove" defaultCheck radio="Keeper of the Grove" /> 
  <Checkbox id="EC" spellId={202770} name="Elune's Chosen" radio="Keeper of the Grove" />
  <Checkbox id="OPENFLARE" spellId={202347} name="Stellar Flare" defaultCheck radio="Stellar Flare" />
  <Checkbox id="OPENCONVOKE" spellId={391528} name="Convoke the Spirits" defaultCheck radio="Convoke the Spirits" />
  <Checkbox id="MEDITATION" spellId={474728} name="Lycara's Meditation" defaultCheck />

</CheckboxProvider>

[*~OPENFLARE&&~OPENCONVOKE&&~EC&&~KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 194153, 164815, 164812, 194223, 197626, 197626, 197626]} > Start casting at max range 4 seconds before pull. </Timeline>

[*~OPENFLARE&&OPENCONVOKE&&~EC&&~KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 194153, 164815, 164812, 194223, 197626, 197626, 197626, 391528]} > Start casting at max range 4 seconds before pull. </Timeline>

[*~OPENFLARE&&OPENCONVOKE&&~EC&&~KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 190984, 194153, 164815, 164812, 194223, 197626, 197626, 197626, 391528]} > Be in !Bear Form! then start casting at max range 4 seconds before pull. </Timeline>

[*OPENFLARE&&OPENCONVOKE&&~EC&&~KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 202347, 164815, 164812, 194223, 197626, 197626, 197626, 391528]} > Start casting at max range 4 seconds before pull. </Timeline>

[*OPENFLARE&&~OPENCONVOKE&&~EC&&~KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 202347, 164815, 164812, 194223, 197626, 197626, 197626]} > Start casting at max range 4 seconds before pull. </Timeline>

[*OPENFLARE&&~OPENCONVOKE&&~EC&&~KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 190984, 202347, 164815, 164812, 194223, 197626, 197626, 197626]} > Be in !Bear Form! then start casting at max range 4 seconds before pull. </Timeline>

[*~OPENFLARE&&~OPENCONVOKE&&~EC&&~KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 190984, 202347, 164815, 164812, 194223, 197626, 197626, 197626]} > Be in !Bear Form! then start casting at max range 4 seconds before pull. </Timeline>

[*OPENFLARE&&OPENCONVOKE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 202347, 164815, 164812, 205636, 194223, 197626, 197626, 197626, 391528]} > Start casting at max range 4 seconds before pull.   </Timeline>

[*OPENFLARE&&OPENCONVOKE&&~EC&&~KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 190984, 202347, 164815, 164812,194223, 197626, 197626, 197626, 391528]} > Be in !Bear Form! then start casting at max range 4 seconds before pull.   </Timeline>

[*OPENFLARE&&~OPENCONVOKE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 202347, 164815, 164812, 205636, 194223, 197626, 197626, 197626]} > Start casting at max range 4 seconds before pull. </Timeline>

[*~OPENFLARE&&OPENCONVOKE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 194153, 164815, 164812, 205636, 194223, 197626, 197626, 197626, 391528]} > Start casting at max range 4 seconds before pull. </Timeline>

[*~OPENFLARE&&~OPENCONVOKE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 190984, 194153, 164815, 164812, 205636, 194223, 197626, 197626, 197626]} > Start casting at max range 4 seconds before pull. </Timeline>
...
[*~OPENFLARE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 194153, 164815, 194153, 205636, 197626, 197626]} > Cast !Wrath! 2 seconds before pull, then pull the boss with !Starfire! and apply dots before entering !Eclipse!. </Timeline>

[*OPENFLARE&&~EC&&KEEPER&&~MEDITATION] <Timeline spellIds={[190984, 194153, 164815, 202347, 194153, 205636, 197626, 197626]} > Cast !Wrath! 2 seconds before pull, then pull the boss with !Starfire! and apply dots before entering !Eclipse!. </Timeline>
...
[*~OPENFLARE&&~EC&&KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 194153, 164815, 194153, 205636, 197626, 197626]} > Cast !Wrath! 2 seconds before pull, then pull the boss with !Starfire! and apply dots before entering !Eclipse!. </Timeline>

[*OPENFLARE&&~EC&&KEEPER&&MEDITATION] <Timeline spellIds={[5487, 190984, 194153, 164815, 202347, 194153, 205636, 197626, 197626]} > Cast !Wrath! 2 seconds before pull, then pull the boss with !Starfire! and apply dots before entering !Eclipse!. </Timeline>
...
- Enter !Solar Eclipse! and cast !Wrath! on 1 target.
- If talented into !Soul of the Forest! and !Umbral Intensity!, enter !Lunar Eclipse! and cast !Starfire! on 2 targets. Otherwise, enter !Solar Eclipse! and cast !Wrath!.
...
### These builds will be updated as people are progressing the raid and builds are more solidified and figured out.

<Talents name={"Single Target Without New 4pc"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUmtMGzMwDYWYZmZAzMGmZbGLjZmZMLzYmxMGbYjBYA22GLYamZZEAAAgNzMzMDsZgB"}/>

<Talents name={"Single Target With New 4pc"} talents={"CYGAkuH5GdQpDrgY32rlVGnyqBAAAAAAAAAAAAAAAAAALUmtMGzMwDYWYZmZAzMbjlZ2mxCzMzYWmxMjZM2wGDwAstNWw0MzyoAAQAsxMzMgNjhB"}/>

<Talents name={"Single Target Cleave"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALUGNjxMD8AmFWmZGgZ2mZZmtZswMzMmlZMGzYshNGgBYbbsgpZmlRAAAA2MzMzA2MGG"}/>

<Talents name={"AoE"} talents={"CYGAkuH5GdQpDrgY32rlVGnyqBAAAAAAAAAAAAAAAAAALUmtmxYmBeAzCLzMDYmZxsMzyMz2MzMzMziZZMMYDLMAjltZ2wY2GBmCAABwCzYA2MGG"}/>
...
Embellishments in The War Within don't offer a substantial gain, so it's important that you always sim your character using [Raidbots Top Gear](https://www.raidbots.com/simbot/topgear) before making any gearing decision. Usually the best options for crafting early in the season will be on higher stat budget items like weapons. Here are some guidelines:
...
### Do I have to shapeshift for !Lycara's Meditation! in my rotation? 

- No. There has been no proof yet that shapeshifting rotationally is a dps gain. The haste buff from caster form is not retained after shifting into your form. 
