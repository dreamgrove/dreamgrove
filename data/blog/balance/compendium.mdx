...
The buffs to !Starsurge! and our overall damage equal to a total 8-10% total buff for ST. For AoE it will vary depending on what build/talents you play. The talent selections between content are overall the same as they were prior, with a few more opportunities to play EC in raid over KOTG.

Overall, the changes take boomkin closer to the middle of the pack DPS wise
...
- [*Nature's GraceEC&&Lunar CallingST] Use !Starfire! to spend any stacks of !Nature's Grace! before using !Convoke the Spirits!.
...
<Talents name={"Keeper of the Grove build"} talents={"CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWoYmZmhxMzAmZYmZsAbMbmZmlZmFjZmZGbzYMMDbgFAMAbLjFMNzsMCAAAwmZGG"}/>
...
- [Afenar The War Within (KechhaUI edit)](https://wago.io/hCRbakfyr)
