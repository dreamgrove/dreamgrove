...
> 
> Elune’s Chosen: !Boundless Moonlight! - !Fury of Elune! final flash of Energy damage reduced by 10%. !Minor Moon! damage reduced by 10%.
...
### Sunfire/Moonfire Target Count Tracker

> [!Warning]
> This Weakaura is not a recommended way to track your DoT's on multiple targets, but it is something that gets asked about a lot.

[This weakaura](https://wago.io/H4HSBd_CD) shows icons for !Moonfire!/!Sunfire! and how many targets are affected by your dots. It is generally not recommended to use as tracking your dots through a nameplate profile is much more efficient and you will often be in situations where dotting mobs with !Moonfire! is inefficient.
