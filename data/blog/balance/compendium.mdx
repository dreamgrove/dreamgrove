...
> [!NOTE]
> These builds are templates that will serve you well in most cases. For specific builds and explanations for each boss, check out the [raid guide](https://www.dreamgrove.gg/raids/liberation_of_undermine) and click the "Balance" checkbox. These builds will be updated continously as people progress Manaforge Omega.
