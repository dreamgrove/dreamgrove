...
<CheckboxProvider>
  ...
  <Checkbox isIcon id="OPENFLARE" spellId={202347} name="Stellar Flare" defaultCheck radio="Stellar Flare" />
  <Checkbox isIcon id="OPENCONVOKE" spellId={391528} name="Convoke the Spirits" defaultCheck radio="Convoke the Spirits" />
  <Checkbox isIcon id="MEDITATION" spellId={474728} name="Lycara's Meditation" defaultCheck />
</CheckboxProvider>
...
<CheckboxProvider>
    ...
    <Checkbox isIcon id="Control of the Dream" spellId={434249} name="Control of the Dream" defaultCheck radio="Control of the Dream" />
