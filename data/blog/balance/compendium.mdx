...
On the reset May 13th/14th Blizzard is launching the [turbo boost event](https://www.wowhead.com/guide/the-war-within/turbo-boost-dinar-event-overview) increasing item levels for myth track and hero track items, as well as introducing the Puzzling Cartel Chip (dinar).
