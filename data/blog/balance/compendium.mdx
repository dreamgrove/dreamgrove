...
[Patch 11.1.7](https://www.wowhead.com/news/patch-11-1-7-official-patch-notes-releases-june-17th-377229) is releasing with the new [D.I.S.C Belt](https://www.wowhead.com/ptr/item=245964/durable-information-securing-container?bonus=523&class=11&ilvl=701&spec=102) that works similiarly to the [Cyrce's Circlet](https://www.wowhead.com/item=228411/cyrces-circlet) from 11.0.7. The base ilvl of the belt is 684 increasing through 4 weeks of weekly content to a maximum of 701.

The recommended effects for the belt currently is [Charged Bolts](https://www.wowhead.com/ptr/spell=1236109/charged-bolts) (ST damage proc) for raid and ST encounters, and [Spark Burst](https://www.wowhead.com/ptr/spell=1236273/spark-burst) (haste) for M+. There is a chance that [Electric Current](https://www.wowhead.com/ptr/spell=1236961/electric-current) (mastery) can be good depending on your stats. You should always sim your character to make a decision that is best for your character. It is worth equipping the belt instantly after you've acquired the powers.
