...
<Checkbox id="Nature's GraceKOTG" spellId={392162} name="Nature's Grace" />
...
<Checkbox id="Nature's GraceEC" spellId={392162} name="Nature's Grace" />
...
- [*Lunar Calling&&Warrior of EluneEC] Use !Warrior of Elune! 
- [*~Lunar Calling&&Warrior of EluneEC] Use !Warrior of Elune! if your eclipse has less than 7 seconds left and you will enter Solar Eclipse next.
- [*Lunar Calling] Use !Wrath! to enter Lunar Eclipse
...
<CheckboxProvider>
<Checkbox id="KOTGAoE" name="Keeper Of The Grove" defaultCheck radio="Hero" />
<Checkbox id="ECAoE" name="Elune's Chosen" defaultCheck radio="Hero" />
...
- [*Force of NatureAoE] Use !248280|Force of Nature! if one of the following conditions is met:
