...
- As is tradition, a handful of people from the Dreamgrove community have spent time collecting feedback to help the developers as we look towards 11.0.7 and beyond. The post is focused in part on changes made in 11.0.5, but also touches on some fundamental concerns with the spec. If you're passionate about Balance Druid, we'd love for everyone to get involved by leaving **respectful** comments in the post and upvote if you agree with it. This will help keep it visible and ensure we have the best chance of getting our feedback heard. You can find the post [here](https://us.forums.blizzard.com/en/wow/t/balance-druid-feedback-1105-and-beyond/1996585).
