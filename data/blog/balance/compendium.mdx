...
The update will not change your decision in gearing much, with the [Cyrce's Circlet](https://www.wowhead.com/item=228411/cyrces-circlet) ring from 11.0.7 still being your best option in that slot. 

There is a section in [Gear & Consumables](https://www.dreamgrove.gg/blog/balance/compendium#puzzling-cartel-chip) listing the items you should look out for when spending your Puzzling Cartel Chip.
