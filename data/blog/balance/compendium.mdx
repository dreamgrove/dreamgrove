...
- If talented into !114107|Soul of the Forest! and !Umbral Intensity!, enter !Lunar Eclipse! and cast !Starfire! on 2 targets. Otherwise, enter !Solar Eclipse! and cast !Wrath!.
...
!Warrior of Elune! is an off-gcd ability, making your next 3 !Starfire! instant for 25 seconds. The ability has a 45s cooldown that starts once you've pressed it. It should be used on cooldown while talented into !Lunar Calling!, or you can hold for a few seconds to line up with cooldowns.
...
- !Sunseeker Mushroom! or !Wild Mushroom! are mandatory talents since they help saturate the [4-piece](https://www.wowhead.com/spell=1215698/druid-balance-11-1-class-set-4pc) uptime. 
  ...
  !Crashing Star! is an optional talent in ST, but requires you to route through !114107|Soul of the Forest!. Can freely take this option over !Hail of Stars!.
...
This macro will target the [Synergistic Brewtaliser](https://www.wowhead.com/item=219299/synergistic-brewterializer?bonus=4795&class=11&ilvl=678&spec=102) barrel and use !Sunfire! to proc the damage, and then change back to your previous target.

```
#showtooltip
/target Backfill Barrel
/cast Sunfire
/targetlasttarget
```
