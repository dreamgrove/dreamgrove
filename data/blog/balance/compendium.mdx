...
<details>
<summary>Keeper of the Grove</summary>
...
<Checkbox id="Nature's GraceKOTG" spellId={450347} name="Nature's Grace" />
...
- Start casting !Starfire! when your current Eclipse has less duration 
...
<details>
<summary>Elune's Chosen</summary>
...
- [*Nature's GraceEC&&Convoke the SpiritsEC] Use !Starfire! if all of the following conditions is met:
  - You have stacks of !Dreamstate!
  - You are in CA and your next global would be !Convoke the Spirits!
...
<Checkbox id="Nature's GraceKAOE" spellId={450347} name="Nature's Grace" />
