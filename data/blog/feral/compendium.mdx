...
[Ulgrax Build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkREQBQNUVFURFVVSlUQECFUEFVVUBA): there’s enough adds on Mythic to justify Druid of the Claw with light AOE, with 1-minute Stampeding Roar possibly being quite useful as well. The boss is immune while adds are up, so no funnel opportunities.

[Bloodbound Horror Build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBQMVFFURFVVWlUQCFUEFVVUBA): You can probably play a single-target Druid of the Claw build here and just cleave Ravages onto the adds, however if you need more add damage just play the Ulgrax build. 

[Sikran Build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGURVVRSFVQUCFVEFVVUCEQ) Pure single-target with a bit of downtime, probably just play Wildstalker, though if you want to try [DOTC](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBQMVFFURFVVWlUQCFUEFVVUBA), or Wildstalker [without Moonfire](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGURFVVSFVQUCFVEFVVUCEQ). 

[Rasha’nan Build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUVFURFVVSFVQUCFVEFVVUCEQ):  the adds aren’t too significant, but will recommend Primal Wrath just in case you can get some funnel with Apex, and with this I think Wildstalker might be more useful because you’re already taking Apex and Circle in the single-target build, as here it’s not as much about killing the adds but utilising them to funnel. However if you want to pad and nuke the adds, the best parsing build is probably [DOTC](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBUNUVFURFVVSlUQECFUEFVVUBA). However it may simply just be best to play pure single-target.

[Broodtwister Build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBQNUVFURFVVSlUQECFUEFVVUBA): the most AOE-focused fight, you should probably play Druid of the Claw here, especially as the adds need to be nuked quickly. If you need that extra bit of AOE, you can consider a build like [this](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBQNUVFURFVVSFVQUCFVEFVVUBA), or if you need even [more AOE](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBUNUVFUVFVRSFVQUCFVEFVVUBA) with !391709|Rampant Ferocity!.

[Princess Build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGURVVRSFVQUCFVEFVVUCEQ): pure single-target, your build options are the same as with Sikran. 

[Silken Court Build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFUAAiFQVEQRKkBUQBQNURGURVVRSFVEUCVQEFVVUCUQ): The boss with the highest cook potential. Given its a council-esque fight with extended cleave on 2 targets, Wildstalker might be the best on paper as you can easily maintain DOTs on both. There’s also the option for a build [without Moonfire](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFUAAiFQVEQRKkBUQBQNUVFVRFVRSFVEUCFVEFVVUCUQ). However you may also want to try a [DOTC build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFUAAiFQVEQRKkBUQBQNUVFURFVVSFVEUCFVEFVVUBA), especially if you prefer something easier to play. Lastly even a [L/R build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFUAAiFQVEQRKkBUQBQNURGVRVVEYlEEUBVEFVVUCUQ) without Berserk is competitive. Experiment!

[Queen Ansurak Build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFUAAiFQVEQRKkBUQBUNUVFURFVVSlUQECFUEFVVUBA): this boss has DOTC written all over it, as burst AOE can be very valuable here, however you also don’t want to compromise too much single-target, hence why you may want to keep !421432|Saber Jaws! talented, though if you need more AOE you can also [adjust](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFUAAiFQVEQRKkBUQBUNUVFURFVVSFVQUCFVEFVVUBA).

Lastly, some general purpose raid builds:

[WS ST](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGURVVRSFVQUCFVEFVVUCEQ)
[Without Moonfire](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGURVVRSFVQUCFVEFVVUCEQ)
[WS ST L Build](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUFGVRVFVKFUQQCFQEFVVUCEQ)
[WS Hybrid ST-AOE](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQiFQVEERKkBUQBQNUVFVRFVRSFVQUCFVEFVVUCEQ)
[DOTC ST](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQBQgFUVEERKkBUQBQMVFFURFVVWlUQCFUEFVVUBA)
[DOTC Hybrid ST-AOE](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFUAAiFQVEQRKkBUQBQNUVFURFVVSlUQECFUEFVVUBA)
...
[DOTC  All-Rounder](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQAQgFUVEERalBEQBQNUVFRVFVRWFVAUCBVEFVVUBQ)

[DOTC Burst Build](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQAQgFUVEERalBEQBQNUVFRVFVRaEVAUCBVEFVVUBQ)

[DOTC Double-Rake](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQAQgFUVEERalBEQBQNURVUVFVRaEVAUCVUEFVVUBQ) 

[DOTC Heavy-ST](https://www.wowhead.com/talent-calc/druid/feral/druid-of-the-claw/DARFFQAQgFUVEERalBEQBQNUVFUVFVRSlUAUCFUEFVVUBA) 

[Wildstalker Basic](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQgFUVEERalBEQBQNURVVVFRRWFVAUCVQEFVVUCAA)

[Wildstalker ST/funnel](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQgFUVEERalBEQBQNURVUVFVRWFVAUCVQEFVVUCAA) 

[Wildstalker Bees+Moonfire](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQgFUVEERalBEQBQNURVVUVRRSFVEUCVQEFVVUCAA)

[Wildstalker Thrashing Claws+Moonfire](https://www.wowhead.com/talent-calc/druid/feral/wildstalker/DARFFQAQgFUVEERalBEQBQNUVUVUVRRSFVEUCVREFVVUCAA)
...
!449645|Savage Fury!: great burst and great for larger pull sizes, however a little bit less effective on single-target. Longer travel time between packs in some dungeons can give time for TF to reset, thereby giving talents like this higher overall uptime as well.
