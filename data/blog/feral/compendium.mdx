...
## Prepatch
This compendium is not updated for prepatch, but a large majority of this information still applies. For single-target build, move the point that was in Dire Fixation to a 2nd point in !Tireless Energy!. For AoE/Dungeon builds, ensure you select !Rampant Ferocity!. 

This guide will be updated for the War Within expansion closer to release.
...
- [*Primal Wrath-AOE] Use !Primal Wrath! if you have 5 combo points, or at least 4 combo points outside of !Berserk!/!102543|Incarnation! and any of these conditions are met:
    - [*Rampant Ferocity-AOE] !Rip!s from !Primal Wrath! are in pandemic
