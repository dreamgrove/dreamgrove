...
All Wowhead and Icy Veins class guides always have "BiS" lists, but we only want to use ours to get an idea of what pieces we will find valuable. As Resto Druids, we use the following tools to determine what gear to equip and where we might find upgrades.
...
**[Raidbots](https://www.raidbots.com/simbot/)**: Raidbots is the default resource for actually simulating Resto Druid damage, like for application in M+.
