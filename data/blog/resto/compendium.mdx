...
This page should serve as a hub and an explainer for the best guides and resources available for Resto Druid Raid and M+ gameplay. It is up-to-date as of the global launch of The War Within and will receive updates when Season 1 starts and Nerub-ar Palace opens.
...
- **[Icy Veins](https://www.icy-veins.com/wow/restoration-druid-pve-healing-guide)**: Resto Druid pages on Icy Veins are written and kept up-to-date by Torty. His write-ups build on foundational class knowledge and offer more in-depth explanations on optimising our kit for different content and scenarios.
  - Nerub-ar Palace encounter guide by Torty to be linked when published
...
- **[Questionably Epic](https://questionablyepic.com/restodruid-sheet/)**: Resto Druid pages on Questionably Epic are written by Voulk. Our other guides above will basically always be kept more up-to-date than QE as its "simulation" side linked below is the higher priority.
  - [Nerub-ar Palace encounter guide](https://questionablyepic.com/nerubar-palace/) by Broccoliz
...
Again, we all use different stuff, so you will need to do some groundwork to find or make what works best for you. Here are some good starting points:
