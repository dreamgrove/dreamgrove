...
- **[Questionably Epic](https://questionablyepic.com/restodruid-sheet/)**: Resto Druid pages on Questionably Epic are written by Voulk. Our other guides above will basically always be kept more up-to-date than QE as its "simulation" side linked in the "Simming" section below will always be the highest priority.
