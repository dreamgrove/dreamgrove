...
### Sporefall
QELive is up-to-date with these items, so refer to Top Gear for your BiS
...
```
CkGA8cL7tpvige+kkmGM9zUPWbMmZb2mxMzY2GeAmZ2mxitZAAAAAAAAAAwihmNzYamBYWGzMzwwDMAAAAAMAAA22GLYamZZAAMbzs0sNzmNmZmZwMbY0MAYmZmBgB
```
...
- Cast !Swiftmend! on yourself on cooldown to extend your Lifebloom and spend !Soul of the Forest! on Rejuv
...
There's currently a few different ways to approach dungeon talents. You'll be playing Wildstalker regardless.

> [!CAUTION]
> As you push higher you will need to think for yourself and also fail sometimes.
...
```
CkGA8cL7tpvige+kkmGM9zUPWPMmZbMjZmxsN8AMzsNjFbzAAAAAAAAAAgNDNbMmmBMmFzMzMLGGAAAAAMAAGwyyYBTzMLDAgZbmtmtZWsxYmZwMbY0MAAzMAMA
```
...
```
CkGA8cL7tpvige+kkmGM9zUPWPMmZbMjZmxsNmHgxsNjFbzAAAAAAAAAAgtBNbMmmZMMmFzMzMLzwDYAAAAAAAwAWWGLYamZZAAMbzs1sNziNmZmHAmZB0MAAzMAMA
```
