...
I've seen a lot of questions surface recently about diminishing returns --- what they are, how they are (or aren't) related to damage reduction, and what stats are and aren't affected. Let's break it down.
...
The same is true for Dodge/Parry, Block, and Stagger --- the proofs of which I'll leave as exercises to the reader.

Finally, let's confirm a theory about Versatility. As I mentioned earlier, every point of Versatility rating provides the same amount of damage reduction regardless of how much Versatility you already have. We also know that every percent of damage reduction provides more effective health than the last, and so we should observe that Versatility also has these increasing returns.
