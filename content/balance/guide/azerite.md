...
### Sims (Chickendb (Link Website))

For the most up to date simulations of our Azerite traits, you should use Chickendb.com. This website will compare Azerite traits both on an individual level and with multiple traits, being a useful way to figure out everything you need to know about this system. Remember to use logic when referring to sims and if you have any questions, be sure to talk to us in the Dreamgrove!
