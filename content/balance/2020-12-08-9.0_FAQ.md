...
This legendary has received NO tuning so this will not be the final iteration. As it stands it gives 16 Niya mastery stacks and uses a deck of cards system which makes Convoke always cast 1 Full Moon in 2 Convoke casts. It also slightly more than halves the Starsurges and Wrath casts. With current tuning it is very weak and wouldn't see play.
...
**This is currently bugged to not work with the Endless Thirst conduit on PTR.** This legendary roughly adds 8+5 seconds during Bloodlust or 6+5 seconds without Bloodlust to the Frenzy effect. Would require us to play with {{< spell 340706 "Precise Alignment" >}} conduit and Incarnation(outside AoE) and allows for extremely high burst every 3min over the ~35 seconds, ~~probably~~ beating anything else in the game for "bursts" of that duration. The tuning of this legendary will single-handedly decide whether Venthyr will be good or not as it's roughly a 15% dps gain which is about twice as good as all other available legendaries for us.

Again all these changes are TENTATIVE and there may be more to come.
