...
Notes: Conflux is always used and the only choice to be made is between your 2nd potency slot which should be Fury or Umbral most of the time. This is mostly dungeon/personal preference as the have around the same throughput.
...
**Finesse:**
- {{< spell 341280 "Born Anew" >}}: Good default pick, a main stat buff for a friend of yours. Can be used before a pull if a player can suicide and then take be rezzed. It can also be traded in conjunction with Innervate for Power Infusion if a Discipline Priest in present in the raid.
- {{< spell 341450 "Front of the Pack" >}}: By default good whenever you want to use your roar and is especially good on Artificer (Covers out the whole duration of Annihilation) and on Sire Denathrius (Really good in P1 intermission, P3 1st and 2nd Massacre and Ravage overlaps)
