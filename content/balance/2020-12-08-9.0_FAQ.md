...
No, our dots (Moonfire, Sunfire, Stellar Flare) do NOT snapshot, everything is dynamic. That means that if i were to use Moonfire in Lunar Eclipse then do into Solar Eclipse, the buff from mastery onto moonfire would be lost.

## 21. What is my filler priority inside {{< spell 194223 "CA" >}}?

1 Target:
- Starfire if above 110% haste (You would currently need both Bloodlust and Power Infusion.)
- Wrath if below 109% haste
