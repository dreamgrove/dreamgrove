...
{{< spell 171273 "Potion of Spectral Intellect" >}} for all cases.
...
If you do not lose a {{< spell 323764 "Convoke" >}} cast yes, if not press it on cooldown. Similarly you delay CA for {{< spell 323764 "Convoke" >}} if you would not lose a CA cast. The exception for this is when using a strong on use trinket like Quantum Device or Empyreal Ordnance in which case you should always delay {{< spell 323764 "Convoke" >}} for CA unless the fight would be over before you could combo them again.
