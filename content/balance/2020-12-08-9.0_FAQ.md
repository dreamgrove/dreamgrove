...
Extremely strong effect when paired with someone who benefits a lot from haste or stats in general (whoever that may be). Has the potential to make Kyrian viable in a simp meta.
...
Useless on single target but has a lot of potential for 2-4 targets as it allows for much higher uptime. Increases the offensive swarms you get per cast from 2 to 3.56 which equates to a 78% increase. Still does not make Necrolord competitive (for now).
...
Has a lot of potential and roughly adds 8+5 seconds during Bloodlust or 6+5 seconds without Bloodlust. Would require you to play with {{< spell 340706 "Precise Alignment" >}} and {{< spell 102560 "Incarnation" >}} and allows for extremely high burst every 3min over the ~30 seconds, probably beating any other "bursts" of that duration. 
