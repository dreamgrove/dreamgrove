...
Has a lot of potential and roughly adds 8+5 seconds during Bloodlust or 6+5 seconds without Bloodlust. Would require you to either play with the CA extension conduit and Inc and allows for extremely high burst every 3min over the ~30 seconds, probably beating anything else in the game for "bursts" of that duration. 
