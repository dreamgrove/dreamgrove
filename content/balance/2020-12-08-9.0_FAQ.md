...
Use them asap when Lunar Eclipse is active and when only Solar Eclipse is active don't use them unless you are moving even if it means the proc expires.
