...
- The secondary stat granted is randomly selected from stat from the player's two highest secondary stats in terms of rating. In Bloodlust however, the highest stat will be chosen.
