...
- {{< spell 340720 "Stellar Inspiration" >}}: Will become a good option with Pulsar and the 4pc set bonus from 9.2 ({{< spell 363497 "Umbral Infusion" >}}).

Notes: 
  - This should be used as a priority list, going from top to bottom.
  - {{< spell 340720 "Stellar Inspiration" >}} will be on par with {{< spell 340706 "Precise Alignment" >}} with {{< spell 363497 "Umbral Infusion" >}} equipped.
...
{{< item 355315 "Sinful Hysteria" >}} with Mastery + Haste

**Kyrian:**

{{< item 354115 "Kindred Affinity" >}} with Mastery + Haste
...
With {{< item 354115 "Kindred Affinity" >}} you prefer to bond with a Night Fae because of the haste. Kyrian sadly gives very poor value and should be avoided.
A sheet for Kindred Affinity value for the current patch can be found [here](https://docs.google.com/spreadsheets/d/1wV2AickO4uLMXAMEgYiiVIrtxxKJForOvdQWXN5oqhg/edit#gid=0)
An experimental sheet for 9.2 with tier sets and 2 legendaries can be found [here](https://docs.google.com/spreadsheets/d/1baQypWt2RjCYvtRQ7T5fPXqK18FeZON9XtR-LRvSGXo/edit?usp=sharing). **It is to note that the list is most likely highly inaccurate because most of the tier sets and double legendaries are not yet implemented and/or optimised.** 
