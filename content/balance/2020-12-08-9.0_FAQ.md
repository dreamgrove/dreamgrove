...
**Venthyr:**
- 100% of the time [Nadja](https://www.wowhead.com/soulbind-calc/night-fae/Nadja/druid) with Dauntless Duelist for ST and a 3rd potency slot for AOE.
...
In M+: {{< item 355315 "Sinful Hysteria" >}} for slightly more st and {{< spell 338657 "Circle" >}} or {{< spell 338668 "Pulsar" >}} for more AoE.

Note: Until Sinful Hysteria becomes available you can use Circle / Pulasr for aoe and Dreambinder / BOAT for ST
...
{{< item 355315 "Sinful Hysteria" >}} on Belt because of the Domination Sockets.

**{{< spell 338668 "Pulsar" >}} slot:**

Shoulders because of higher stat budget.
