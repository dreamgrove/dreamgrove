...
{{< talents spec="balance" src="live" recommend="322,113,223,333,133,113,311" >}}

Default AoE setup (M+ and heavy AoE bosses):
{{< talents spec="balance" src="live" recommend="322,113,223,333,311,331,311" >}}
Note that {{< spell 248280 "Force of Nature" >}} can and should be used in M+ for any key level where the tank could die even though they are a minor dps loss. The choice between TM and Drift depends on how long targets live and how much value the movement has.

Mixed target count or mostly spread AoE (Inerva, Council):
{{< talents spec="balance" src="live" recommend="311,113,223,333,232,331,311" >}}
{{< spell 102560 "Incarnation" >}} should only be used for spread AoE.
