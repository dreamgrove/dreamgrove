...
## [15. How do I play with BoAT?](#boat)

</div>

This only applies to single target encounters.

- Always pool so that you enter a new Eclipse with enough Astral Power to chain 3 Starsurges. Movement may mean you sometimes only get 2.
...
- Stellar Inspiration: Probably not ever worth using with only two Potency slots available
...
**Finesse:**
- Born Anew: Good default pick, a static 12 mainstat buff for a friend of yours. Can be used after a wipe is called. It can also be traded in conjunction with Innervate for Power Infusion if a Discipline Priest in present in the raid.
...
- Born of the Wilds: Good on Sun King's Salvation or in M+ if you have to offheal a lot.
