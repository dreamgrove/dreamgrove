...
Usable Trinkets:
- Slot 1 (EO): Empyreal Ordnance is the only trinket slotable as it is the only reason this build exists.
- Slot 2 (another on-use): Inscrutable Quantum Device, Instructor's Divine Bell and others.
...
Usable trinkets:
- Slot 1 (Equip): Cabalist's Hymnal, Unbound Changeling, Insignia of Alacrity and others.
- Slot 2 (On-use): Inscrutable Quantum Device, Instructor's Divine Bell, Soulletting Ruby and others. 
...
Usable trinkets:
- Slot 1+2 (Equip): Cabalist's Hymnal, Unbound Changeling, Insignia of Alacrity and others.
...
Insigina of Alacrity: Another equip trinket which has both positives and negatives. The negatives being that the trinket has a low stat budget and the positives being that it can be easily acquired through PvP at 226 ilvl if you can reach 2.1k rating.
