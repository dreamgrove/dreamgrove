...
**Pure Single Target as Night Fae with {{< spell 339942 "BoAT" >}}:**

- If you have CA and {{< spell 323764 "Convoke" >}} off cooldown, then use them both together (refer to [#19](#swifty-macro)) when below 40 AP. For Cooldown usage refer to [#9](#convoke-delay)

- Transition into the next Eclipse if you are currently not in one

- Dump 3x Starsurges right at the start of the new eclipse
...
- Use Starsurge if you are going to overcap and will not lose one of your 3 Starsurges at the start of the next eclipse

- Use Wrath (inside Solar Eclipse) or Starfire (inside Lunar Eclipse) until you reach the next eclipse

**Notes:**

- Cycle between Ecilpses as soon as possible

- Prioritise Solar Eclipse if possible (after using CA the eclipse states reset and you are able to proc either Lunar or Solar Eclipse)

- If you are any covenant other than Night Fae your Celestial Alignment should be used after banking 90 Astral Power for the Rule of 3

- With {{< spell 323764 "Convoke" >}} use up all of your Astral Power at the end of the previous Eclipse so that you enter the next Eclipse with less than 40 Astral Power and can cast {{< spell 323764 "Convoke" >}}.

- If you are at or above 70ap you can use either 2 Starfires or 3 Wraths and you will have enough AP in order to transition eclipses correctly (due to Solstice and Nature's Balance AP generation)
...
- If you started an eclipse inside a Bloodlust window you will most likely need to use 4 Starsurges inside an eclipse, in that case if the 4th Starsurge is not needed for movement, use it as soon as possible, as it buffs your current eclipse
...
1 Target:
- Starfire if at or above 110% haste (You would currently need both Bloodlust and Power Infusion or other external haste buffs in order to reach this ammount. A weakaura tracking your current haste value might come in handy.)
...
**Soulbinds:**
- 99% of the time Niya - Poision and the 2nd Potency should be picked over Burrs whenever there are constant 3+ targets
...
- Precise Alignment: Around the same value as Fury and Umbral, you can pick it if you dont know which of the other two to pick, might have some value if you want to extend your burst windows on aoe.
- Stellar Inspiration: Currently not ever worth using with only two Potency slots available

Notes: Conflux is always used and the only choice to be made is between your 2nd potency slot which should be Fury or Umbral most of the time. This is mostly dungeon/personal preference as the have around the same dmg output.

**Endurance:**
- Well-honed Instincts: Default go to, one of the the most overtuned endurance conduits in the game raid wise.
- Ursine Vigor: Really good if you will ever go into bear form to soak an ability. Especailly good on progression and if you will ever press Heart of the Wild while being talented into Guardian Affinity. Examples: SLG Goliath wicked blade overlap / Sludgefist 2nd Chain Slam.
...
- Layered Mane: Unbelievably useless for Boomie.

Notes: Pick Instincts and default into one of the other three usable conduits as your second choice.

**Finesse:**
- Born Anew: Good default pick, a mainstat buff for a friend of yours. Can be used before a pull if a player can suicide then take the ressurection. It can also be traded in conjunction with Innervate for Power Infusion if a Discipline Priest in present in the raid.
- Front of the Pack: By default good whenever you want to use your roar and is especially good on Artificer (Decks out the whole duration of Anihilation) and on Sire Denathrius (really good in P1 intermission, P3 1st and 2nd Massacre and Ravage overlaps)
