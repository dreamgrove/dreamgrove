...
**{{< spell 274281 "Moons" >}} recharge time reduced from 25 seconds to 20 seconds:**

Weak buff that does make it good enough for single target and Moons still suck in AoE.

**{{< spell 343647 "Solstice" >}} increased Shooting Stars chance reduced from 300% to 200%:**

Major 33% nerf that makes this talent only usable on spread AoE.

**{{< spell 202354 "Stellar Drift" >}} reworked to no longer increase duration but damage by 25% instead of 15% and adds a 15 second CD to Starfall:**
...
**Kyrian: Kindred Affinity: Give your partner a permanent 5% crit and you get a permanent 5% stat based on their covenant. This bonus is increased to 10% while the bond is active:**

Kyrian: Mastery
Night Fae: Crit
Venthyr: Haste
Necrolord: Versatility
While inside the bond window, the stats granted by the legendary are doubled.
...
**Night Fae: Celestial Spirits: Halves the cooldown and spells cast by Convoke (to 1min CD and 8 spells cast) and increases the chance of a Full Moon:**
...
**Necrolord: Wrathful Swarm: Adaptive Swarm has a 30% chance to split into 2 Swarms when it expires on a target:**

Useless on single target but has a lot of potential for 2-4 targets as it allows for much higher uptime. Still does not make Necrolord competitive.

**Venthyr: Sinful Hysteria: Every time you cast a spell during Ravenous Frenzy its duration is increased by 0.2 seconds:**

Has a lot of potential and roughly adds 8 seconds during Bloodlust or 6 seconds without Bloodlust. Would require you to either play with the CA extension conduit or Inc and makes it already very long duration even more problematic especially in m+ environments where you are often lucky you get a pack to live 20 seconds in the first place.

Again all these changes are TENTATIVE and there will be more changes to come.
...
- Keep Starfall permanently up above anything else.

- Keep Sunfire permanently up. If the mobs aren't stacked yet wait with this until they are.
