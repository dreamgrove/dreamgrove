...
- If you have CA and {{< spell 323764 "Convoke" >}} off cooldown, then use them both together (refer to #19) when below 40 AP. For Cooldown usage refer to #9

- Transition into the next Eclipse
