...
{{< spell 22812 "Barkskin" >}} - 20% DR on 60sec CD (reduced by Conduit and Symbol of Hope - 265144), usable while stunned, frozen, incapacitated, feared or asleep. Also prevents your casts from being pushed back.
...
{{< spell 2908 "Soothe" >}} - Enrage dispell on an enemy, 8s CD (CD incurs even if nothing is dispelled)
...
{{< spell 774 "Rejuvenation" >}} - hot (instant) 12s dur every , force shifts into Human Form
