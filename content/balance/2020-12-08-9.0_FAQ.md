...
Has a lot of potential and roughly adds 8 seconds during Bloodlust or 6 seconds without Bloodlust. Would require you to either play with the CA extension conduit or Inc but will most likely only end up being usable in raid due to the very long duration (if at all).
