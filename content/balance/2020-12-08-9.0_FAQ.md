...
Currently it reduces the spells cast by 1/4 and casts 2.4 Wraths, 2.2 Starsurges, 0.9 Starfalls and 0.425 Full Moons on average when every target is dotted. This is about half the balance specs you would get without the Legi for Wrath and Starsurge. Addtionally the legendary reduces the amount of cards in the deck for Full Moon from 5 to 2 but gives the Full Moon card only a 85% chance to proc the Full Moon.
