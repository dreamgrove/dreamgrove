...
With the current iteration of Domination Sockets you should use the Chaos Bane set. After you get the set, you should look to get the Bek shard, which is a 1% dps increase and as your last shard use the Cor shard, which is the lowest dps increase with 0.5%.
