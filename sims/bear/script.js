$(function () {
  ...
  function getT15(r) {
    return talentCode['15'][r.tal.charAt(0)]
  }
  function getT40(r) {
    return talentCode['40'][r.tal.charAt(4)]
  }
  function getT45(r) {
    return talentCode['45'][r.tal.charAt(5)]
  }
  function getT50(r) {
    return talentCode['50'][r.tal.charAt(6)]
  }
  ...
  var whLinks = {
    ...
    covenant:
      '<a href=https://www.wowhead.com/guides/covenant-specific-legendaries-in-shadowlands-9-1>Covenant</a>',
  }
  ...
  var legendaries = {
    ...
    circle:
      'finger1=shadowghast_ring,id=178926,gem_id=173129,enchant=tenet_of_critical_strike,bonus_id=7085/6647/6650/6758/',
  ...
  var defaultOptions = {
        ...
        clickCallback: function (e, value, filters, pivotData) {
          ...
          if ($tar.hasClass('pvtVal')) {
            ...
            $.get(prof, (d) => {
              ...
              if (soulbinds_m[r.soul] !== '') {
                isH() ? cond.push(soulbinds[r.soul]) : cond.push(soulbinds_m[r.soul])
              }
              if (r.cond1 !== 'none') {
                cond.push(r.cond1)
              }
    ...
    onRefresh: function (c) {
      ...
      ;(async () => {
        ...
        const runs = await fetch(
          'https://api.github.com/repos/dreamgrove/dreamgrove/actions/workflows/' + action + '/runs'
        )
        ...
        const commit = await fetch(
          'https://api.github.com/repos/dreamgrove/dreamgrove/commits?path=/static/sims/bear/' +
            file
        )
    ...
    derivedAttributes: {
      ...
      Conduit3: (r) => {
        if (r.cond3) {
          return toCap(r.cond3.replaceAll('_', ' '))
        } else {
          return 0
        }
      },
    ...
    sorters: {
      T15: (a, b) => {
        return Number(getTalentNum('15', a)) - Number(getTalentNum('15', b))
      },
      T40: (a, b) => {
        return Number(getTalentNum('40', a)) - Number(getTalentNum('40', b))
      },
      T45: (a, b) => {
        return Number(getTalentNum('45', a)) - Number(getTalentNum('45', b))
      },
      T50: (a, b) => {
        return Number(getTalentNum('50', a)) - Number(getTalentNum('50', b))
      },
    },
  }
...
;(async () => {
  const content = await fetch(
    'https://api.github.com/repos/dreamgrove/dreamgrove/contents/static/sims/bear/'
  )
