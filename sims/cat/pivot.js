;(function () {
  ...
  callWithJQuery(function ($) {
        ...
        return function () {
          ...
          return function (data, rowKey, colKey) {
            return {
              ...
              value: function () {
                return (
                  this.inner.value() / data.getAggregator.apply(data, this.selector).inner.value()
                )
              },
      ...
      try {
        ...
        fn1 = function (attr) {
                ...
                .bind('keyup', function () {
                  ...
                  accept_gen = function (prefix, accepted) {
                    return function (v) {
                      ...
                      return (
                        (ref1 = Math.sign(sorter(v.toLowerCase(), real_filter))),
                        indexOf.call(accepted, ref1) >= 0
                      )
                    }
                  }
                  accept =
          ...
          closeFilterBox = function () {
            if (
              valueList.find("[type='checkbox']").length >
          ...
          attrElem = $('<li>')
            .addClass('axis_' + i)
            .append(
              $('<span>').addClass('pvtAttr').text(attr).data('attrName', attr).append(triangleLink)
            )
          if (hasExcludedItem) {
            attrElem.addClass('pvtFilteredAttribute')
          }
        ...
        refreshDelayed = (function (_this) {
          return function () {
            ...
            numInputsToProcess =
              (ref4 = opts.aggregators[aggregator.val()]([])().numInputs) != null ? ref4 : 0
            vals = []
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (
                x = t = 0, ref5 = numInputsToProcess;
                0 <= ref5 ? t < ref5 : t > ref5;
                x = 0 <= ref5 ? ++t : --t
              ) {
                newDropdown = $('<select>')
            ...
            subopts.filter = function (record) {
              ...
              for (k in exclusions) {
                ...
                if (
                  ((ref6 = '' + ((ref7 = record[k]) != null ? ref7 : 'null')),
                  indexOf.call(excludedItems, ref6) >= 0)
                ) {
                  return false
                }
              }
    ...
    $.fn.heatmap = function (scope, opts) {
      ...
      colorScaleGenerator =
        opts != null ? ((ref = opts.heatmap) != null ? ref.colorScaleGenerator : void 0) : void 0
