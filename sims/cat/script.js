  ...
  var defaultOptions = {
    ...
    onRefresh: function (c) {
      ...
      ;(async () => {
        ...
        const action = isPtr() ? 'update_json_ptr_cat.yml' : 'update_json_cat.yml'
        ...
        const commit = await fetch(
          'https://api.github.com/repos/dreamgrove/dreamgrove/commits?path=/static/sims/cat/' + file
        )
...
;(async () => {
  const content = await fetch(
    'https://api.github.com/repos/dreamgrove/dreamgrove/contents/static/sims/cat/'
  )
