$(function() {
    ...
    var defaultOptions = {
        ...
        onRefresh: function(c) {
            ...
            (async () => {
                const runs = await fetch('https://api.github.com/repos/dreamgrove/dreamgrove/actions/workflows/update_json_tree.yml/runs');
                ...
                const commit = await fetch('https://api.github.com/repos/dreamgrove/dreamgrove/commits?path=/static/sims/tree/' + file);
...
(async () => {
    const content = await fetch('https://api.github.com/repos/dreamgrove/dreamgrove/contents/static/sims/tree/');
